...
取得元URLとファイル名は `public-sample-corpus/manifest.json` に保存されます。評価結果は `public-sample-evaluation-output/evaluation_summary.json`、`evaluation_summary.md`、`evaluation_cases.csv` に出ます。
